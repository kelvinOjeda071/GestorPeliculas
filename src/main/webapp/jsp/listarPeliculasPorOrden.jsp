<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <head>
            <meta charset="UTF-8">
            <title>Listar Películas por orden</title>
            <style>
                table,
                th,
                td {
                ...
                <%@include file="../templates/banner_usuario.html" %>
                    ...
                    <div class="wrapper">
                        <table class="table table-striped">
                            ...
                            <c:forEach items="${peliculasPorOrden}" var="pelicula">
                                <tr>
                                    ...
                                    <td><a href="AlquilarPeliculaController?idPelicula=${pelicula.id}" class="text-decoration-none btn btn-dark">Alquilar</a>
                                    </td>
